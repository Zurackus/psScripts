...
write-host "`n"
Write-Host "        Machine Power Options        " -foregroundcolor Yellow -BackgroundColor DarkGreen
...
while(($select = Read-Host "Enter Number for Selection or Q to quit") -ne 'Q')
    {
    ...
    2 {
        ...
        Write-Host "Startup in progress"
        write-host "`n"
        Get-PowerMainMenu
    }
    3 {
