$spreadsheet = Import-Csv -Path "C:\Users\tkonsonlas\Documents\ExportList2.csv"       
...
########## Install Software On PC ##########
    ...
    Copy-Item -Path "\\hrgatad\SCCM\Applications\MSMonitorAgent-x86\*" -Destination "\\$Computer\c$\deleteme\MSMonitorAgent" -Recurse
    Start-Sleep -Seconds 2
