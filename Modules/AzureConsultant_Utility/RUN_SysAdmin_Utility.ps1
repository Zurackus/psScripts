<#
This is here simply to trigger the first 'Start-SysAdminUtility' by right clicking this file and 'Run with Powershell'

If desired, the folder 'SysAdmin_Utility' can be dropped into the PowerShell 'Module' folder.
