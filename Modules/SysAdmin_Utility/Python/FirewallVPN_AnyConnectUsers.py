...
ASA_VPN = {
    ...
    "host": "192.168.205.7",#Management IP of the device you are connecting to
    "username": user,
    "password": pwd,
    "port" : 22,
    "secret" : pwd,
